...
namespace Google.Cardboard.Sensors.Internal
{
	...
	{
		private const double M_SQRT1_2 = 0.7071067811865476D;
		private const double ONE_6TH = 0.16666667163372D;
		private const double ONE_20TH = 0.16666667163372D;
...

		{
			...
			result.set((so3.get(2, 1) - so3.get(1, 2))/2.0D, (so3.get(0, 2) - so3.get(2, 0))/2.0D,
	 ...
	 * Qualified Name:     Google.Cardboard.Sensors.internal.So3Util
