 namespace com.google.vrtoolkit.cardboard.sensors.@internal
 {
	 ...
	 {		   public double[] m = new double[9];
	   ...
	   {			 this.m[0] = o.m[0];
		   ...
		   public virtual void set(double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22)
	   ...
	   public virtual double SameDiagonal
	   {
		   ...
		   {					 double tmp19_18 = (this.m[8] = value);
			 this.m[4] = tmp19_18;
			 this.m[0] = tmp19_18;
