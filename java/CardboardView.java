     ...
     implements GLSurfaceView.Renderer
   {
       ...
       CardboardView.this.queueEvent(new Runnable()
       {
         public void run()
         {
           synchronized (CardboardView.RendererHelper.this)
           {
             ...
             CardboardView.RendererHelper.this.mRenderer.onRendererShutdown();
     ...
     public void setCardboardDeviceParams(CardboardDeviceParams newParams)
     {
       ...
       CardboardView.this.queueEvent(new Runnable()
       {
         public void run()
         {
           CardboardView.RendererHelper.this.mHmd.setCardboard(deviceParams);
     ...
     public void setScreenParams(ScreenParams newParams)
     {
       ...
       CardboardView.this.queueEvent(new Runnable()
       {
         public void run()
         {
           CardboardView.RendererHelper.this.mHmd.setScreen(screenParams);
           CardboardView.RendererHelper.this.mProjectionChanged = true;
         }
       });
     }
     ...
     public void setInterpupillaryDistance(final float interpupillaryDistance)
     {
       CardboardView.this.queueEvent(new Runnable()
       {
         public void run()
         {
           CardboardView.RendererHelper.this.mHmd.getCardboard().setInterpupillaryDistance(interpupillaryDistance);
           CardboardView.RendererHelper.this.mProjectionChanged = true;
         }
       });
     }
     ...
     public void setFOV(final float fovY)
     {
       CardboardView.this.queueEvent(new Runnable()
       {
         public void run()
         {
           CardboardView.RendererHelper.this.mHmd.getCardboard().setFovY(fovY);
           CardboardView.RendererHelper.this.mProjectionChanged = true;
         }
       });
     }
     ...
     public void setDistortionCorrectionScale(final float scale)
     {
       CardboardView.this.queueEvent(new Runnable()
       {
         public void run()
         {
           ...
           CardboardView.this.mDistortionRenderer.setResolutionScale(scale);
         }
       });
     }
     ...
     public void setVRModeEnabled(final boolean enabled)
     {
       CardboardView.this.queueEvent(new Runnable()
       {
         public void run()
         {
           ...
           CardboardView.RendererHelper.this.mProjectionChanged = true;
           CardboardView.RendererHelper.this.onSurfaceChanged((GL10)null, CardboardView.RendererHelper.this.mHmd.getScreen().getWidth(), CardboardView.RendererHelper.this.mHmd.getScreen().getHeight());
         }
       });
     }
     ...
     public void onDrawFrame(GL10 gl)
     {
       ...
       if (this.mProjectionChanged)
       {
         ...
         if (!this.mVRMode)
         {
           ...
           Matrix.perspectiveM(this.mMonocular.getTransform().getPerspective(), 0, cdp.getFovY(), aspectRatio, this.mZNear, this.mZFar);
         }
         ...
         else
         {
           ...
           leftEyeFov.toPerspectiveMatrix(this.mZNear, this.mZFar, this.mLeftEye.getTransform().getPerspective(), 0);
           
           rightEyeFov.toPerspectiveMatrix(this.mZNear, this.mZFar, this.mRightEye.getTransform().getPerspective(), 0);
       ...
       if (this.mVRMode)
       {
         if (this.mDistortionCorrectionEnabled)
         {
           ...
           else
           {
             ...
             this.mLeftEye.getViewport().setViewport((int)(leftX * this.mDistortionCorrectionScale), (int)(leftY * this.mDistortionCorrectionScale), (int)(leftWidth * this.mDistortionCorrectionScale), (int)(leftHeight * this.mDistortionCorrectionScale));
             
 
 
 
             this.mRightEye.getViewport().setViewport((int)(rightX * this.mDistortionCorrectionScale), (int)(rightY * this.mDistortionCorrectionScale), (int)(rightWidth * this.mDistortionCorrectionScale), (int)(rightHeight * this.mDistortionCorrectionScale));
             ...
             this.mLeftEye.getViewport().setViewport(leftX, leftY, leftWidth, leftHeight);
             
             this.mRightEye.getViewport().setViewport(rightX, rightY, rightWidth, rightHeight);
           }
