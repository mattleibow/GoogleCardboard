...
/*  11:    */ {
/*  12:    */   private static final String TAG = "DistortionRenderer";
...
/* 119:138 */     GLES20.glScissor(0, 0, this.mHmd.getScreen().getWidth() / 2, this.mHmd.getScreen().getHeight());
/* 120:    */     
/* 121:    */ 
/* 122:    */ 
/* 123:142 */     renderDistortionMesh(this.mLeftEyeDistortionMesh);
/* 124:    */     
/* 125:144 */     GLES20.glScissor(this.mHmd.getScreen().getWidth() / 2, 0, this.mHmd.getScreen().getWidth() / 2, this.mHmd.getScreen().getHeight());
/* 126:    */     
/* 127:    */ 
/* 128:    */ 
...
/* 145:    */   }
/* 146:    */   
/* 147:    */   public void setResolutionScale(float scale)
/* 148:    */   {
/* 149:178 */     this.mResolutionScale = scale;
/* 150:    */   }
/* 151:    */   
/* 152:    */   public void onProjectionChanged(HeadMountedDisplay hmd, EyeParams leftEye, EyeParams rightEye, float zNear, float zFar)
/* 153:    */   {
/* 154:199 */     this.mHmd = new HeadMountedDisplay(hmd);
/* 155:200 */     this.mLeftEyeFov = new FieldOfView(leftEye.getFov());
/* 156:201 */     this.mRightEyeFov = new FieldOfView(rightEye.getFov());
/* 157:    */     
/* 158:203 */     ScreenParams screen = this.mHmd.getScreen();
/* 159:204 */     CardboardDeviceParams cdp = this.mHmd.getCardboard();
...
/* 165:    */     
/* 166:213 */     leftEye.getFov().toPerspectiveMatrix(zNear, zFar, leftEye.getTransform().getPerspective(), 0);
/* 167:    */     
/* 168:215 */     rightEye.getFov().toPerspectiveMatrix(zNear, zFar, rightEye.getTransform().getPerspective(), 0);
/* 169:    */     
/* 170:    */ 
...
/* 173:220 */     float xPxPerM = screen.getWidth() / screen.getWidthMeters();
/* 174:221 */     float yPxPerM = screen.getHeight() / screen.getHeightMeters();
/* 175:222 */     int textureWidthPx = Math.round(textureWidthM * xPxPerM);
/* 176:223 */     int textureHeightPx = Math.round(textureHeightM * yPxPerM);
/* 177:    */     
/* 178:225 */     float xEyeOffsetMScreen = screen.getWidthMeters() / 2.0F - cdp.getInterpupillaryDistance() / 2.0F;
/* 179:226 */     float yEyeOffsetMScreen = cdp.getVerticalDistanceToLensCenter() - screen.getBorderSizeMeters();
/* 180:    */     
/* 181:    */ 
...
/* 184:    */ 
/* 185:    */ 
/* 186:233 */     xEyeOffsetMScreen = screen.getWidthMeters() - xEyeOffsetMScreen;
...
/* 196:    */   {
/* 197:244 */     ScreenParams screen = this.mHmd.getScreen();
/* 198:245 */     CardboardDeviceParams cdp = this.mHmd.getCardboard();
/* 199:    */     
/* 200:247 */     float eyeToScreenDistanceM = cdp.getEyeToLensDistance() + cdp.getScreenToLensDistance();
/* 201:248 */     float leftM = (float)Math.tan(Math.toRadians(eye.getFov().getLeft())) * eyeToScreenDistanceM;
/* 202:    */     
/* 203:250 */     float rightM = (float)Math.tan(Math.toRadians(eye.getFov().getRight())) * eyeToScreenDistanceM;
/* 204:    */     
/* 205:252 */     float bottomM = (float)Math.tan(Math.toRadians(eye.getFov().getBottom())) * eyeToScreenDistanceM;
/* 206:    */     
/* 207:254 */     float topM = (float)Math.tan(Math.toRadians(eye.getFov().getTop())) * eyeToScreenDistanceM;
/* 208:    */     
/* 209:    */ 
/* 210:257 */     EyeViewport vp = new EyeViewport(null);
...
/* 217:    */     
/* 218:265 */     float xPxPerM = screen.getWidth() / screen.getWidthMeters();
/* 219:266 */     float yPxPerM = screen.getHeight() / screen.getHeightMeters();
/* 220:267 */     eye.getViewport().x = Math.round(vp.x * xPxPerM);
/* 221:268 */     eye.getViewport().y = Math.round(vp.y * xPxPerM);
/* 222:269 */     eye.getViewport().width = Math.round(vp.width * xPxPerM);
/* 223:270 */     eye.getViewport().height = Math.round(vp.height * xPxPerM);
/* 224:    */     
/* 225:272 */     return vp;
/* 226:    */   }
/* 227:    */   
...
/* 229:    */   {
/* 230:280 */     return new DistortionMesh(eye, this.mHmd.getCardboard().getDistortion(), this.mHmd.getScreen().getWidthMeters(), this.mHmd.getScreen().getHeightMeters(), xEyeOffsetMScreen, yEyeOffsetMScreen, textureWidthM, textureHeightM, eyeViewport.eyeX, eyeViewport.eyeY, eyeViewport.x, eyeViewport.y, eyeViewport.width, eyeViewport.height);
/* 231:    */   }
/* 232:    */   
/* 233:    */   private void renderDistortionMesh(DistortionMesh mesh)
/* 234:    */   {
/* 235:292 */     GLES20.glBindBuffer(34962, mesh.mArrayBufferId);
/* 236:293 */     mesh.getClass();mesh.getClass();GLES20.glVertexAttribPointer(this.mProgramHolder.aPosition, 3, 5126, false, 20, 0 * 4);
/* 237:    */     
/* 238:    */ 
/* 239:    */ 
/* 240:    */ 
...
/* 244:    */     
/* 245:302 */     mesh.getClass();mesh.getClass();GLES20.glVertexAttribPointer(this.mProgramHolder.aVignette, 1, 5126, false, 20, 2 * 4);
/* 246:    */     
/* 247:    */ 
/* 248:    */ 
/* 249:    */ 
...
/* 253:    */     
/* 254:311 */     mesh.getClass();mesh.getClass();GLES20.glVertexAttribPointer(this.mProgramHolder.aTextureCoord, 2, 5126, false, 20, 3 * 4);
/* 255:    */     
/* 256:    */ 
/* 257:    */ 
/* 258:    */ 
...
/* 345:411 */       throw new RuntimeException("Framebuffer is not complete: " + Integer.toHexString(status));
/* 346:    */     }
...
/* 404:    */   {
/* 405:468 */     ProgramHolder holder = new ProgramHolder(null);
/* 406:469 */     holder.program = createProgram("attribute vec2 aPosition;\nattribute float aVignette;\nattribute vec2 aTextureCoord;\nvarying vec2 vTextureCoord;\nvarying float vVignette;\nuniform float uTextureCoordScale;\nvoid main() {\n    gl_Position = vec4(aPosition, 0.0, 1.0);\n    vTextureCoord = aTextureCoord.xy * uTextureCoordScale;\n    vVignette = aVignette;\n}\n", "precision mediump float;\nvarying vec2 vTextureCoord;\nvarying float vVignette;\nuniform sampler2D uTextureSampler;\nvoid main() {\n    gl_FragColor = vVignette * texture2D(uTextureSampler, vTextureCoord);\n}\n");
/* 407:470 */     if (holder.program == 0) {
/* 408:471 */       throw new RuntimeException("Could not create program");
/* 409:    */     }
...
/* 413:477 */       throw new RuntimeException("Could not get attrib location for aPosition");
/* 414:    */     }
...
/* 418:482 */       throw new RuntimeException("Could not get attrib location for aVignette");
/* 419:    */     }
...
/* 424:488 */       throw new RuntimeException("Could not get attrib location for aTextureCoord");
/* 425:    */     }
...
/* 430:494 */       throw new RuntimeException("Could not get attrib location for uTextureCoordScale");
/* 431:    */     }
...
/* 436:500 */       throw new RuntimeException("Could not get attrib location for uTextureSampler");
/* 437:    */     }
...
/* 447:510 */       throw new RuntimeException(op + ": glError " + error);
/* 448:    */     }
/* 449:    */   }
/* 450:    */   
...
/* 457:    */   {
/* 458:    */     private static final String TAG = "DistortionMesh";
/* 459:    */     public static final int BYTES_PER_FLOAT = 4;
/* 460:    */     public static final int BYTES_PER_INT = 4;
/* 461:527 */     public final int COMPONENTS_PER_VERT = 5;
/* 462:528 */     public final int DATA_STRIDE_BYTES = 20;
/* 463:530 */     public final int DATA_POS_OFFSET = 0;
/* 464:531 */     public final int DATA_VIGNETTE_OFFSET = 2;
/* 465:532 */     public final int DATA_UV_OFFSET = 3;
/* 466:533 */     public final int ROWS = 40;
/* 467:534 */     public final int COLS = 40;
/* 468:537 */     public final float VIGNETTE_SIZE_M_SCREEN = 0.002F;
/* 469:    */     public int nIndices;
/* 470:542 */     public int mArrayBufferId = -1;
/* 471:543 */     public int mElementBufferId = -1;
/* 472:    */     
/* 473:    */     public DistortionMesh(EyeParams eye, Distortion distortion, float screenWidthM, float screenHeightM, float xEyeOffsetMScreen, float yEyeOffsetMScreen, float textureWidthM, float textureHeightM, float xEyeOffsetMTexture, float yEyeOffsetMTexture, float viewportXMTexture, float viewportYMTexture, float viewportWidthMTexture, float viewportHeightMTexture)
/* 474:    */     {
