...
/*  33:    */   }
/*  34:    */   
/*  35:    */   public void set(double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22)
/*  36:    */   {
/*  37: 68 */     this.m[0] = m00;
/*  38: 69 */     this.m[1] = m01;
/*  39: 70 */     this.m[2] = m02;
...
/*  46:    */   }
/*  47:    */   
/*  48:    */   public void set(Matrix3x3d o)
/*  49:    */   {
...
/*  59:    */   }
/*  60:    */   
/*  61:    */   public void setZero()
/*  62:    */   {
/*  63:100 */     double tmp63_62 = (this.m[2] = this.m[3] = this.m[4] = this.m[5] = this.m[6] = this.m[7] = this.m[8] = 0.0D);this.m[1] = tmp63_62;this.m[0] = tmp63_62;
/*  64:    */   }
/*  65:    */   
/*  66:    */   public void setIdentity()
/*  67:    */   {
/*  68:107 */     double tmp41_40 = (this.m[3] = this.m[5] = this.m[6] = this.m[7] = 0.0D);this.m[2] = tmp41_40;this.m[1] = tmp41_40; double 
/*  69:108 */       tmp63_62 = (this.m[8] = 1.0D);this.m[4] = tmp63_62;this.m[0] = tmp63_62;
/*  70:    */   }
/*  71:    */   
/*  72:    */   public void setSameDiagonal(double d)
/*  73:    */   {
/*  74:117 */     double tmp19_18 = (this.m[8] = d);this.m[4] = tmp19_18;this.m[0] = tmp19_18;
/*  75:    */   }
/*  76:    */   
/*  77:    */   public double get(int row, int col)
/*  78:    */   {
/*  79:128 */     return this.m[(3 * row + col)];
/*  80:    */   }
/*  81:    */   
/*  82:    */   public void set(int row, int col, double value)
/*  83:    */   {
/*  84:139 */     this.m[(3 * row + col)] = value;
/*  85:    */   }
/*  86:    */   
/*  87:    */   public void getColumn(int col, Vector3d v)
/*  88:    */   {
...
/*  92:    */   }
/*  93:    */   
/*  94:    */   public void setColumn(int col, Vector3d v)
/*  95:    */   {
...
/*  99:    */   }
/* 100:    */   
/* 101:    */   public void scale(double s)
/* 102:    */   {
/* 103:172 */     this.m[0] *= s;
/* 104:173 */     this.m[1] *= s;
/* 105:174 */     this.m[2] *= s;
...
/* 112:    */   }
/* 113:    */   
/* 114:    */   public void plusEquals(Matrix3x3d b)
/* 115:    */   {
...
/* 125:    */   }
/* 126:    */   
/* 127:    */   public void minusEquals(Matrix3x3d b)
/* 128:    */   {
...
/* 153:    */   }
/* 154:    */   
/* 155:    */   public void transpose(Matrix3x3d result)
/* 156:    */   {
...
/* 202:    */   }
/* 203:    */   
/* 204:    */   public boolean invert(Matrix3x3d result)
/* 205:    */   {
