...
/*   4:    */ {
/*   5:    */   private static final float NS2S = 1.0E-009F;
...
/*  28: 47 */   private boolean timestepFilterInit = false;
/*  29:    */   private int numGyroTimestepSamples;
/*  30: 49 */   private boolean gyroFilterValid = true;
...
/* 111:    */   }
/* 112:    */   
/* 113:    */   public double getHeadingDegrees()
/* 114:    */   {
...
/* 129:    */   }
/* 130:    */   
/* 131:    */   public synchronized void setHeadingDegrees(double heading)
/* 132:    */   {
/* 133:187 */     double currentHeading = getHeadingDegrees();
/* 134:188 */     double deltaHeading = heading - currentHeading;
...
/* 137:    */     
/* 138:192 */     double[][] deltaHeadingRotationVals = { { c, -s, 0.0D }, { s, c, 0.0D }, { 0.0D, 0.0D, 1.0D } };
/* 139:    */     
...
/* 142:    */   }
/* 143:    */   
/* 144:    */   public double[] getGLMatrix()
/* 145:    */   {
/* 146:206 */     return glMatrixFromSo3(this.so3SensorFromWorld);
/* 147:    */   }
/* 148:    */   
/* 149:    */   public double[] getPredictedGLMatrix(double secondsAfterLastGyroEvent)
/* 150:    */   {
...
/* 168:    */       }
/* 169:    */     }
/* 170:242 */     double tmp62_61 = (this.rotationMatrix[11] = 0.0D);this.rotationMatrix[7] = tmp62_61;this.rotationMatrix[3] = tmp62_61; double 
/* 171:243 */       tmp86_85 = (this.rotationMatrix[14] = 0.0D);this.rotationMatrix[13] = tmp86_85;this.rotationMatrix[12] = tmp86_85;
/* 172:    */     
/* 173:    */ 
...
/* 177:    */   }
/* 178:    */   
/* 179:    */   public synchronized void processGyro(float[] gyro, long sensorTimeStamp)
/* 180:    */   {
/* 181:258 */     float kTimeThreshold = 0.04F;
/* 182:259 */     float kdTdefault = 0.01F;
/* 183:260 */     if (this.sensorTimeStampGyro != 0L)
/* 184:    */     {
/* 185:261 */       float dT = (float)(sensorTimeStamp - this.sensorTimeStampGyro) * 1.0E-009F;
/* 186:262 */       if (dT > 0.04F) {
...
/* 208:    */   }
/* 209:    */   
/* 210:    */   public synchronized void processAcc(float[] acc, long sensorTimeStamp)
/* 211:    */   {
...
/* 268:    */   }
/* 269:    */   
/* 270:    */   public void processMag(float[] mag, long sensorTimeStamp)
/* 271:    */   {
