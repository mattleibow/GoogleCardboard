...
/*   1:    */ namespace com.google.vrtoolkit.cardboard
 {
	...
	/*   4:    */	 using FloatMath = android.util.FloatMath;
	/*   5:    */ 
	/*   6:    */	 public class HeadTransform
	/*   7:    */
	 {	/*   8:    */	   private const float GIMBAL_LOCK_EPSILON = 0.01F;
	/*   9:    */	   private const float PI = 3.141593F;
	/*  10:    */	   private readonly float[] mHeadView;
	/*  11:    */   
	...
	/*  23:    */	   public virtual void getHeadView(float[] headView, int offset)
	/*  24:    */
	   {	/*  25: 62 */		 if (offset + 16 > headView.Length)
		 {
	/*  26: 63 */		   throw new System.ArgumentException("Not enough space to write the result");
	/*  27:    */
		 }	/*  28: 66 */		 Array.Copy(this.mHeadView, 0, headView, offset, 16);
	/*  29:    */
	   }	/*  30:    */   
	/*  31:    */	   public virtual void getTranslation(float[] translation, int offset)
	/*  32:    */
	   {	/*  33: 86 */		 if (offset + 3 > translation.Length)
		 {
	/*  34: 87 */		   throw new System.ArgumentException("Not enough space to write the result");
	/*  35:    */
	...
	/*  41:    */	   public virtual void getForwardVector(float[] forward, int offset)
	/*  42:    */
	   {	/*  43:108 */		 if (offset + 3 > forward.Length)
		 {
	/*  44:109 */		   throw new System.ArgumentException("Not enough space to write the result");
	/*  45:    */
	...
	/*  51:    */	   public virtual void getUpVector(float[] up, int offset)
	/*  52:    */
	   {	/*  53:127 */		 if (offset + 3 > up.Length)
		 {
	/*  54:128 */		   throw new System.ArgumentException("Not enough space to write the result");
	/*  55:    */
	...
	/*  61:    */	   public virtual void getRightVector(float[] right, int offset)
	/*  62:    */
	   {	/*  63:146 */		 if (offset + 3 > right.Length)
		 {
	/*  64:147 */		   throw new System.ArgumentException("Not enough space to write the result");
	/*  65:    */
	...
	/*  71:    */	   public virtual void getQuaternion(float[] quaternion, int offset)
	/*  72:    */
	   {	/*  73:165 */		 if (offset + 4 > quaternion.Length)
		 {
	/*  74:166 */		   throw new System.ArgumentException("Not enough space to write the result");
	/*  75:    */
	...
	/* 133:    */	   public virtual void getEulerAngles(float[] eulerAngles, int offset)
	/* 134:    */
	   {	/* 135:238 */		 if (offset + 3 > eulerAngles.Length)
		 {
	/* 136:239 */		   throw new System.ArgumentException("Not enough space to write the result");
	/* 137:    */
