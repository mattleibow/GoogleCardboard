/*  1:   */ namespace com.google.vrtoolkit.cardboard
 {
	...
	/* 11:   */   
	/* 12:   */	   public virtual void setViewport(int x, int y, int width, int height)
	/* 13:   */
	   {	/* 14:39 */		 this.x = x;
	/* 15:40 */		 this.y = y;
	...
	/* 20:   */	   public virtual void setGLViewport()
	/* 21:   */
	   {	/* 22:47 */		 GLES20.glViewport(this.x, this.y, this.width, this.height);
	/* 23:   */
	   }	/* 24:   */   
	/* 25:   */	   public virtual void setGLScissor()
	/* 26:   */
	   {	/* 27:52 */		 GLES20.glScissor(this.x, this.y, this.width, this.height);
	/* 28:   */
	   }	/* 29:   */   
	/* 30:   */	   public virtual void getAsArray(int[] array, int offset)
	/* 31:   */
	   {	/* 32:64 */		 if (offset + 4 > array.Length)
		 {
	/* 33:65 */		   throw new System.ArgumentException("Not enough space to write the result");
	/* 34:   */
